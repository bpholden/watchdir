;-----------------------------------------------------------------------
pro lris_throughput_grating_detail_web_page, params
;-----------------------------------------------------------------------
;+
; NAME:
;	LRIS_THROUHGPUT_GRATING_DETAIL_WEB_PAGE
;
; PURPOSE:
;	This procedure will generate a LRIS throughput grating
...
;
; CALLING SEQUENCE:
;       lris_throughput_grating_detail_web_page, outfile, params
;
; INPUTS:
...
;; write the file...
lris_write_web_page, params.detail, body, title=title, CSS=css
