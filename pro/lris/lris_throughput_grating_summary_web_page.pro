;-----------------------------------------------------------------------
pro lris_throughput_grating_summary_web_page, outfile, grating, $
  params, summary
;-----------------------------------------------------------------------
;+
; NAME:
...
title = 'Throughput Data for Grism/Grating '+grating
body = ''
...
body += '<th rowspan="2">Grism/Grating</th>'
...
;; write the file...
lris_write_web_page, outfile, body, title=title, CSS=css
