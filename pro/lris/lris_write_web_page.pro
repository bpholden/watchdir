;-----------------------------------------------------------------------
pro lris_write_web_page, outfile, body, TITLE=title, INDEX=index, CSS=css
;-----------------------------------------------------------------------
;+
; NAME:
;	LRIS_WRITE_WEB_PAGE
;
; PURPOSE:
;       This procedure will write the passed body into a LRIS-format
...
;
; CALLING SEQUENCE:
;       LRIS_WRITE_WEB_PAGE, outfile, title, index, body
;
; INPUTS:
...
;       throughput.html:
;               lris_write_web_page, 'throughput.html', $
...
header += '<img src="http://www.keck.hawaii.edu/realpublic/inst/lris/logo.jpg" align="center">'
header += '</td>'
header += ''
header += '<td bgcolor="#000000">'
header += '<center>'
header += '<b><font color="#ffffff" size="+3">LRIS</font></b>'
header += '<br>'
...
footer += '<nobr><a href="index.html">LRIS Home Page</a></nobr> -' 
